...
const steps = [
  ...
  {
    name: "mood",
    label: "De quel  humeur preferez vous",
    options: [
      "Excitant",
      "Relaxant",
      "Nostalgie",
  ...
  },
  {
    name: "decade",
    label: "Année?",
    options: ["2020", "2010", "2000", "1990", "Older"],
  },
  {
    name: "language",
    label: "Quel langue preferez vous?",
    options: ["English", "Korean", "Spanish", "French", "Other"],
  },
  {
    name: "length",
    label: "Durée souhaitée?",
    options: ["Court (<90 min)", "Standard (90-120 min)", "Long (>120 min)"],
  },
];
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#181818] via-[#232323] to-[#181818] relative overflow-hidden">
      ...
      {recommendation && recommendation.length > 0 ? (
        <div className="w-full max-w-7xl mx-auto mt-2">
          <h2 className="text-2xl font-bold text-white mb-4 text-center">Recommndez pour vous</h2>
